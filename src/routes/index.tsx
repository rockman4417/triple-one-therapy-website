...
function App() {
  ...
  return (
    <RouteSceneLayout scenes={scenes} initialSceneId="home-landing">
      <main className="bg-transparent pt-20 text-stone-900">
        ...
        >
          <div className="route-scene mx-auto max-w-5xl text-center">
            <h1 className="mb-6 text-4xl leading-tight sm:text-6xl" style={{color: "#ede8d1", fontFamily: "maharlika", letterSpacing: "0.2em"}}>
              triple one therapy
            </h1>
            <h1 className="mb-6 text-4xl leading-tight sm:text-6xl" style={{color: "#ede8d1", fontFamily: "maharlika", letterSpacing: "-0.15em"}}>
              111
            </h1>
            <h1 className="mb-6 text-4xl leading-tight sm:text-6xl pinyon" style={{color: "#ede8d1"}}>
