...
export default function SimplePracticeContactWidget({
  className,
  label = 'Contact',
  style,
  ...props
}: SimplePracticeContactWidgetProps) {
  useEffect(() => {
  ...
  return (
    <a
      href="https://clientsecure.me/widget-redirect?scopeId=fbb4bbe6-24e5-457c-bb07-bcdb6ba3320c&applicationId=7c72cb9f9a9b913654bb89d6c7b4e71a77911b30192051da35384b4d0c6d505b&channel=professional_website&appearance=%7B%22fullScreen%22%3Atrue%7D&contact=true&clinicianId=1365778"
      className={
        className ??
